...
filtered_metadata = metadata[metadata['BITSTREAM License'].fillna('').str.contains(r'licenses/by/|licenses/by-sa/', regex=True)]
filtered_metadata = filtered_metadata[filtered_metadata["dc.language"] == "English[eng]"]
